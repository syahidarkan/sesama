      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
            ...
            <div className="flex-1">
              ...
              <div className="grid md:grid-cols-2 gap-4 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="bg-white/70 rounded-lg p-3 border border-blue-100">
                    <h4 className="font-semibold text-blue-900 mb-1">👤 User Info</h4>
                    <p className="text-gray-700 text-xs">
                      Nama, role, dan email pengguna yang melakukan aktivitas
                    </p>
                  </div>
                  <div className="bg-white/70 rounded-lg p-3 border border-blue-100">
                    <h4 className="font-semibold text-blue-900 mb-1">🏷️ Entity</h4>
                    <p className="text-gray-700 text-xs">
                ...
                <div className="space-y-2">
                  <div className="bg-white/70 rounded-lg p-3 border border-blue-100">
                    <h4 className="font-semibold text-blue-900 mb-1">🌐 IP Address</h4>
                    <p className="text-gray-700 text-xs">
                      Alamat IP dari mana aktivitas dilakukan<br/>
                      <span className="font-mono text-xs bg-blue-100 px-1 rounded">::1</span> = localhost (komputer sendiri)<br/>
                      <span className="font-mono text-xs bg-blue-100 px-1 rounded">127.0.0.1</span> = localhost IPv4
                    </p>
                  </div>
                  <div className="bg-white/70 rounded-lg p-3 border border-blue-100">
                    <h4 className="font-semibold text-blue-900 mb-1">📝 Metadata</h4>
                    <p className="text-gray-700 text-xs">
                  ...
                  <div className="flex-1">
                    ...
                    {log.ipAddress && (
                      <div className="mt-2 flex items-center gap-2">
                        ...
                        <span className="text-xs text-gray-600 font-mono bg-blue-50 px-2 py-1 rounded">
                          {log.ipAddress}
                        </span>
                        {log.ipAddress === '::1' && (
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-xl p-6">
          <div className="flex items-start">
            ...
            <div>
              <h3 className="font-semibold text-blue-900 mb-2">Tentang Audit Logs</h3>
