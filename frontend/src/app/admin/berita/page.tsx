                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <Link
                          ...
                          target="_blank"
                          className="inline-flex items-center space-x-1.5 px-3 py-2 rounded-md border border-blue-300 text-blue-700 text-sm font-medium hover:bg-blue-50 transition-colors"
                        >
