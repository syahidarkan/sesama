          ...
          <div className="flex items-center justify-between px-6 py-3">
              ...
              <div className="hidden md:block">
                <div className="relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search..."
                    className="pl-10 pr-4 py-2 w-64 text-sm border border-gray-300 rounded-md focus:border-orange-500 focus:ring-1 focus:ring-orange-500 outline-none"
                  />
                </div>
              </div>
            </div>
            ...
            <div className="flex items-center space-x-3">
              ...
              >
                ...
                <span className="absolute top-1.5 right-1.5 w-2 h-2 bg-orange-600 rounded-full animate-pulse-slow"></span>
              </Link>
              ...
              <div className="relative">
                ...
                >
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-orange-500 to-orange-600 flex items-center justify-center text-xs font-semibold text-white">
                    {user.name.charAt(0).toUpperCase()}
                  </div>
