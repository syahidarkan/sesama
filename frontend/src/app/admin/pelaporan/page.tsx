    ...
    <div className="space-y-6">
                  ...
                  <div className="flex flex-wrap items-center gap-2 ml-13">
                    ...
                    {item.status === 'DRAFT' && hasRole(['CONTENT_MANAGER', 'PENGUSUL']) && (
                      <button
                        ...
                        className="inline-flex items-center px-3 py-1.5 bg-blue-600 text-white rounded-md text-xs font-medium hover:bg-blue-700 transition-colors"
                      >
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-6">
        <div className="flex items-start space-x-3">
          ...
          <div>
            <h3 className="font-semibold text-blue-900 mb-1">Tentang Pelaporan</h3>
