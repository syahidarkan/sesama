        ...
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-600">Daftar semua pelaporan program</p>
            </div>
            <div className="flex items-center gap-4">
              {hasRole(['CONTENT_MANAGER', 'PENGUSUL', 'SUPER_ADMIN']) && (
                <Link
                  href="/admin/pelaporan/create"
                  className="px-4 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 font-semibold transition-colors"
                >
                  + Pelaporan Baru
                </Link>
              )}
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-800">
                Pelaporan digunakan untuk laporan penyaluran dan transparansi program. Semua pelaporan
