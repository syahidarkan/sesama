  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <article className="max-w-5xl mx-auto px-6 py-16">
        ...
        <div className="mb-12">
          ...
          <div className="flex items-center space-x-6">
            <div className="flex items-center space-x-3">
              <div className="w-12 h-12 bg-orange-600 rounded-full flex items-center justify-center text-white text-lg font-bold border border-gray-200 shadow-orange-500/30">
        ...
        {article.program && (
          <div className="mt-16">
            <div className="relative bg-orange-600 rounded-lg overflow-hidden border border-gray-200">
              ...
              <div className="relative p-10">
                <div className="flex flex-col md:flex-row items-center justify-between gap-6">
                  ...
                  <Link
                    href={`/programs/${article.program.slug}`}
                    className="inline-flex items-center px-8 py-4 bg-white text-orange-600 font-bold text-lg rounded-xl border border-gray-200 hover:border border-gray-200 transform hover:-translate-y-1 hover:scale-105 transition-all shrink-0"
                  >
                    Lihat Program
        ...
        <div className="mt-12 flex flex-wrap items-center justify-between gap-6 p-8 bg-white rounded-lg border-2 border-gray-100 border border-gray-200">
          ...
          <div className="flex items-center space-x-3">
            <button className="w-12 h-12 bg-blue-600 hover:bg-blue-700 text-white rounded-xl flex items-center justify-center border border-gray-200 hover:border border-gray-200 transform hover:-translate-y-0.5 transition-all">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
                <path d="M24 4.557c-.883.392-1.832.656-2.828.775 1.017-.609 1.798-1.574 2.165-2.724-.951.564-2.005.974-3.127 1.195-.897-.957-2.178-1.555-3.594-1.555-3.179 0-5.515 2.966-4.797 6.045-4.091-.205-7.719-2.165-10.148-5.144-1.29 2.213-.669 5.108 1.523 6.574-.806-.026-1.566-.247-2.229-.616-.054 2.281 1.581 4.415 3.949 4.89-.693.188-1.452.232-2.224.084.626 1.956 2.444 3.379 4.6 3.419-2.07 1.623-4.678 2.348-7.29 2.04 2.179 1.397 4.768 2.212 7.548 2.212 9.142 0 14.307-7.721 13.995-14.646.962-.695 1.797-1.562 2.457-2.549z"/>
              </svg>
            </button>
            <button className="w-12 h-12 bg-blue-500 hover:bg-blue-600 text-white rounded-xl flex items-center justify-center border border-gray-200 hover:border border-gray-200 transform hover:-translate-y-0.5 transition-all">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
