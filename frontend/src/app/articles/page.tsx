...
export default function ArticlesPage() {
  ...
  const getPlaceholderImage = (index: number) => {
    const images = [
      'https://images.unsplash.com/photo-1554224311-beee460ae6a7?w=600&h=400&fit=crop',
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          <div className="inline-flex items-center justify-center w-16 h-16 bg-primary-600 rounded-full mb-4 border border-gray-200 shadow-md animate-spin">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex items-center justify-between h-20">
            <Link href="/" className="flex items-center space-x-3 group">
              <div className="w-11 h-11 bg-primary-600 rounded-lg flex items-center justify-center border border-gray-200 shadow-md transform group- transition-transform">
            ...
            <Link
              href="/"
              className="inline-flex items-center px-5 py-2.5 bg-white border-2 border-gray-200 text-gray-700 font-semibold rounded-lg hover:border-gray-300 hover:shadow-md transition-all hover:shadow-sm"
            >
        ...
        <div className="relative max-w-7xl mx-auto px-6 py-20">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-primary-50 leading-relaxed mb-8">
              Kami berkomitmen untuk transparan dalam setiap penyaluran dana donasi. Pantau bagaimana setiap rupiah Anda memberikan dampak nyata bagi yang membutuhkan.
            </p>
            <div className="flex flex-wrap items-center gap-6">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <div className="text-sm text-primary-100">Laporan Terverifikasi</div>
                </div>
              </div>
              <div className="flex items-center space-x-3">
                <div className="w-12 h-12 bg-white/20 rounded-lg flex items-center justify-center border border-white/30">
      ...
      <div className="max-w-7xl mx-auto px-6 py-16">
        ...
        {featuredArticle && (
          <div className="mb-20">
            ...
            <Link
              ...
              className="group block bg-white rounded-lg overflow-hidden border border-gray-200  hover:border-primary-200  transition-all duration-200 transform hover:shadow-card-hover"
            >
              <div className="grid lg:grid-cols-2 gap-0">
                <div className="aspect-[4/3] lg:aspect-auto bg-primary-50 overflow-hidden">
                  <img
                    src={featuredArticle.coverImageUrl || getPlaceholderImage(0)}
                    alt={featuredArticle.title}
                    className="w-full h-full object-cover group- transition-transform duration-200"
                  />
                </div>
                <div className="p-10 flex flex-col justify-center">
                  {featuredArticle.program && (
                    <div className="inline-flex items-center space-x-2 bg-primary-50 text-primary-600 px-4 py-2 rounded-full text-sm font-bold mb-4 w-fit border border-primary-200">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {remainingArticles.map((article, index) => (
                <Link
                  ...
                  className="group bg-white rounded-lg overflow-hidden  hover:border-primary-200 shadow-md  transition-all duration-200 transform hover:shadow-card-hover"
                >
                  <div className="aspect-[16/10] bg-gray-100 overflow-hidden">
                    <img
                      src={article.coverImageUrl || getPlaceholderImage(index + 1)}
                      alt={article.title}
                      className="w-full h-full object-cover group- transition-transform duration-200"
                    />
                  </div>
                  <div className="p-6">
                    {article.program && (
                      <div className="inline-block bg-primary-50 text-primary-600 px-3 py-1.5 rounded-lg text-xs font-bold mb-3 border border-primary-100">
        ...
        {articles.length === 0 && (
          <div className="text-center py-20">
            ...
            <Link
              href="/"
              className="inline-flex items-center px-8 py-4 bg-primary-600 text-white font-bold rounded-lg border border-gray-200 shadow-md  hover:shadow-md hover:shadow-sm transition-all"
            >
              Kembali ke Beranda
            </Link>
          </div>
        ...
        {/* CTA Section */}
        <div className="mt-20 relative bg-primary-600 rounded-lg overflow-hidden border border-gray-200">
          <div className="absolute inset-0 bg-grid-white/10 [mask-image:linear-gradient(0deg,transparent,black)]"></div>
          <div className="relative px-8 py-16 text-center">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-white/20 rounded-lg mb-6 border border-white/30">
            ...
            <p className="text-xl text-primary-50 mb-8 max-w-2xl mx-auto leading-relaxed">
              Setiap penyaluran dana dilaporkan secara transparan dan terverifikasi. Pantau dampak nyata dari kontribusi Anda.
            </p>
            <Link
              href="/"
              className="inline-flex items-center px-10 py-5 bg-white text-primary-600 font-bold text-lg rounded-lg border border-gray-200  transform hover:shadow-card-hover  transition-all"
            >
          ...
          <div className="grid md:grid-cols-4 gap-12 mb-12">
            <div className="md:col-span-1">
              <div className="flex items-center space-x-3 mb-4">
                <div className="w-11 h-11 bg-primary-600 rounded-lg flex items-center justify-center border border-gray-200">
                  <svg className="w-6 h-6 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2.5} d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z" />
                  </svg>
                </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/" className="hover:text-primary-400 transition-colors">Donasi Aktif</Link></li>
                <li><Link href="/programs" className="hover:text-primary-400 transition-colors">Semua Program</Link></li>
                <li><Link href="/articles" className="hover:text-primary-400 transition-colors">Laporan</Link></li>
              </ul>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li><Link href="/privacy" className="hover:text-primary-400 transition-colors">Kebijakan Privasi</Link></li>
                <li><Link href="/terms" className="hover:text-primary-400 transition-colors">Syarat & Ketentuan</Link></li>
                <li><Link href="/legal" className="hover:text-primary-400 transition-colors">Informasi Legal</Link></li>
              </ul>
            </div>
          </div>
