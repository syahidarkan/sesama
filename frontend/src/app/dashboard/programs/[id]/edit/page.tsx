                            ...
                            {formData.imageUrl && !imageFiles.length && (
                                <div className="mt-4 p-4 bg-blue-50 rounded-md border border-blue-200">
                                    <div className="flex items-start space-x-3">
                                        ...
                                        <div>
                                            <p className="text-sm font-medium text-blue-900">Gambar saat ini tersimpan</p>
                                            <p className="text-xs text-blue-700 mt-1">Upload gambar baru untuk menggantinya, atau biarkan kosong untuk tetap menggunakan gambar yang ada</p>
                                        </div>
                                    </div>
                                </div>
                            )}
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-8">
                        <div className="flex items-center justify-between mb-6">
                            ...
                            <button
                                ...
                                className="inline-flex items-center space-x-2 px-4 py-2 bg-blue-600 text-white rounded-md text-sm font-medium hover:bg-blue-700 transition-colors"
                            >
