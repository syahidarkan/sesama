          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-2.5 text-sm rounded-md border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500"
                required
              />
            </div>
...
- Dan informasi lainnya"
                rows={15}
                className="w-full px-4 py-2.5 text-sm rounded-md border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 font-mono"
                required
              />
            </div>
            ...
            <div className="bg-teal-50 border border-teal-200 rounded-md p-4">
              <label className="flex items-start cursor-pointer">
                <input
                  ...
                  className="mt-1 mr-3 w-4 h-4 text-teal-600 rounded focus:ring-1 focus:ring-teal-500"
                />
            ...
            {/* Info Box */}
            <div className="bg-cyan-50 border border-blue-200 rounded-md p-4">
              <div className="flex items-start">
                <div className="w-5 h-5 rounded-full bg-cyan-500 text-white flex items-center justify-center text-xs font-bold mr-3 flex-shrink-0 mt-0.5">i</div>
            ...
            <div className="flex gap-3 pt-6 border-t border-gray-200">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 py-2.5 text-sm rounded-md bg-teal-500 text-white font-medium hover:bg-teal-600 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
              >
