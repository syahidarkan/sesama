          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-4">
              ...
              <div className="text-right">
                ...
                <p className="text-2xl font-semibold text-teal-600">{formatCurrency(stats.totalAmount || 0)}</p>
              </div>
            </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="relative">
            ...
            <select
              ...
              className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-300 rounded-md focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none appearance-none bg-white cursor-pointer"
            >
