...
export default function FilesManagementPage() {
  ...
  const getFileIcon = (mimeType: string) => {
    if (mimeType.startsWith('image/')) return <Image className="w-5 h-5 text-cyan-600" />;
      ...
      {stats && (
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-5">
            ...
            <div className="text-2xl font-semibold text-cyan-600 mb-1">
                ...
                {files.map((file) => (
                  <tr key={file.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <span className="inline-flex px-2.5 py-1 text-xs font-medium bg-cyan-50 text-cyan-700 rounded border border-blue-200">
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-right">
                      <div className="flex items-center justify-end space-x-2">
                        <a
                          ...
                          className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-medium border border-blue-300 text-cyan-700 hover:bg-cyan-50 transition-colors"
                        >
                        ...
                        <a
                          ...
                          className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-md text-xs font-medium border border-teal-300 text-teal-700 hover:bg-teal-50 transition-colors"
                        >
