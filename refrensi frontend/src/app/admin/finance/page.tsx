            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {programsFunds.map((program) => (
                  <div key={program.id} className="border border-gray-200 rounded-lg p-5 hover:border-teal-300 transition-colors">
                    ...
                    <div className="space-y-3">
                      ...
                      <button
                        ...
                        className="mt-4 w-full flex items-center justify-center space-x-2 px-4 py-2 bg-teal-500 text-white rounded-lg hover:bg-teal-600 transition-colors"
                      >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {topDonors.map((donor, index) => (
                  <div key={index} className="flex items-center space-x-4 p-4 border border-gray-200 rounded-lg">
                    <div className="w-12 h-12 bg-gradient-to-br from-teal-500 to-cyan-600 rounded-full flex items-center justify-center text-white text-lg font-bold">
                      #{index + 1}
                    </div>
                    <div className="flex-1">
