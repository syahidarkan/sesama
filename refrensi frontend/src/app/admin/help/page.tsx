    ...
    <div className="space-y-6">
      ...
      <div className="max-w-2xl mx-auto animate-fadeIn animate-stagger-1">
        <div className="relative">
          ...
          <input
            ...
            className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none transition-all hover:border-gray-400"
          />
        </div>
      </div>
      ...
      <div className="grid md:grid-cols-3 gap-4 max-w-4xl mx-auto">
        <a
          ...
          className="flex items-start space-x-3 p-6 bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-all hover-lift group animate-fadeIn animate-stagger-2"
        >
          <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-orange-200 transition-all group-hover:scale-110">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-start space-x-3 p-6 bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-all hover-lift group animate-fadeIn animate-stagger-3"
        >
          <div className="w-10 h-10 bg-cyan-100 rounded-lg flex items-center justify-center shrink-0 group-hover:bg-cyan-200 transition-all group-hover:scale-110">
        ...
        <button className="flex items-start space-x-3 p-6 bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-all hover-lift group text-left animate-fadeIn animate-stagger-4">
                  ...
                  return (
                    <div key={index} className="group">
                      ...
                      >
                        ...
                        {isExpanded ? (
                          <ChevronDown className="w-5 h-5 text-teal-600 shrink-0 transition-transform" />
                        ) : (
                          <ChevronRight className="w-5 h-5 text-gray-400 shrink-0 transition-all group-hover:text-teal-600 group-hover:translate-x-1" />
                        )}
                      </button>
                      {isExpanded && (
      ...
      {/* Contact Support */}
      <div className="max-w-4xl mx-auto bg-teal-50 rounded-lg border border-teal-200 p-6 animate-fadeIn animate-stagger-6">
        <h3 className="font-semibold text-gray-900 mb-4">Still need help?</h3>
        <div className="grid md:grid-cols-2 gap-4">
          <a
            href="mailto:support@sesama.com"
            className="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-all hover-lift group"
          >
            <Mail className="w-5 h-5 text-teal-600 transition-transform group-hover:scale-110" />
            <div>
          ...
          <a
            ...
            className="flex items-center space-x-3 p-4 bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-all hover-lift group"
          >
            <Phone className="w-5 h-5 text-teal-600 transition-transform group-hover:scale-110" />
            <div>
