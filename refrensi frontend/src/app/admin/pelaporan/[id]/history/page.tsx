...
export default function PelaporanHistoryPage() {
  ...
  const fetchHistory = async () => {
    try {
      setLoading(true);
      const pelaporanId = params.id as string;

      const historyRes = await pelaporanApi.getHistory(pelaporanId);
      setHistory(historyRes.data || []);
    } catch (error: any) {
      console.error('Failed to fetch pelaporan history:', error);
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-2xl font-bold text-gray-900">Riwayat Pelaporan</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        {loading ? (
          ...
          <div className="space-y-6">
            {/* Info Box */}
            <div className="bg-cyan-50 border border-blue-200 rounded-xl p-6">
              <div className="flex items-start">
                <div className="text-2xl mr-4">Info</div>
                <div>
                      ...
                      <div className="bg-gray-50 rounded-lg p-6 border border-gray-200">
                        <div className="flex items-start justify-between mb-4">
                          <div>
                            ...
                            <p className="text-sm text-gray-600">
                              Tanggal: {formatDate(item.editedAt)}
                            </p>
                            {item.editedBy && (
                              <p className="text-sm text-gray-600">
