        ...
        <div className="bg-white rounded-lg border border-gray-200 p-6 animate-fadeIn animate-stagger-1">
          <div className="text-center">
            <div className="relative inline-block group">
              <div className="w-24 h-24 rounded-full bg-gradient-to-br from-teal-500 to-cyan-600 flex items-center justify-center text-3xl font-semibold text-white mx-auto transition-all group-hover:scale-105">
                {user?.name.charAt(0).toUpperCase()}
              </div>
              <button className="absolute bottom-0 right-0 w-8 h-8 bg-white rounded-full border-2 border-gray-200 flex items-center justify-center hover:bg-gray-50 transition-all hover:scale-110 hover:border-teal-500">
                <Camera className="w-4 h-4 text-gray-600 group-hover:text-teal-600" />
              </button>
            </div>
          ...
          <div className="mt-6 space-y-1">
            ...
            >
              <User className={`w-4 h-4 mr-3 transition-transform hover:scale-110 ${activeTab === 'profile' ? 'text-teal-600' : 'text-gray-400'}`} />
              Profile Info
            </button>
            <button
            ...
            >
              <Lock className={`w-4 h-4 mr-3 transition-transform hover:scale-110 ${activeTab === 'security' ? 'text-teal-600' : 'text-gray-400'}`} />
              Security
            </button>
          </div>
        </div>
            ...
            <div className="space-y-6">
              <div className="flex items-center justify-between pb-4 border-b border-gray-200">
                ...
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="px-4 py-2 bg-teal-500 text-white rounded-md text-sm font-medium hover:bg-teal-600 disabled:opacity-50 transition-all hover-lift"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6">
                ...
                <button
                  onClick={handleSave}
                  disabled={saving}
                  className="px-6 py-2.5 bg-teal-500 text-white rounded-md text-sm font-medium hover:bg-teal-600 disabled:opacity-50 transition-colors"
                >
                  Update Password
                </button>
              </div>
