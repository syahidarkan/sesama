                    ...
                    <td className="px-6 py-4 text-center">
                      <button
                        ...
                        className={`px-3 py-1 rounded-full text-xs font-medium transition-colors ${
                          config.isVisible
                            ? 'bg-teal-100 text-orange-800 hover:bg-orange-200'
...
function UserManagement() {
  ...
  const roleOptions = [
    ...
    { value: 'SUPERVISOR', label: 'Supervisor', color: 'bg-cyan-100 text-cyan-800' },
    { value: 'MANAGER', label: 'Manager', color: 'bg-teal-100 text-orange-800' },
                  ...
                  <tr key={user.id} className={!user.isActive ? 'bg-gray-50' : ''}>
                    ...
                    <td className="px-6 py-4 text-right text-sm space-x-3">
                      ...
                      <button
                        ...
                        className="text-teal-600 hover:text-orange-900"
                      >
                        Nonaktifkan
                      </button>
                      <button
          ...
          <div className="bg-white rounded-lg p-6 max-w-md w-full mx-4">
            ...
            <div className="flex gap-3 mt-6">
              ...
              <button
                ...
                className="flex-1 bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                Buat User
              </button>
            </div>
