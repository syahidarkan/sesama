              ...
              <div key={page.id} className="bg-white rounded-lg shadow-md p-6">
                ...
                <div className="flex gap-3">
                  <button
                    ...
                    className="flex-1 bg-teal-500 text-white px-4 py-2 rounded-lg hover:bg-teal-600 font-medium"
                  >
                    Edit Halaman
                  </button>
                  <a
              ...
              <div className="p-6 space-y-6">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={20}
                    className="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-teal-500 focus:border-teal-500 font-mono text-sm"
