        ...
        {featuredArticle && (
          <div className="mb-20">
            ...
            <Link
              ...
              className="group block bg-white rounded-lg overflow-hidden border border-gray-200 border-2 border-gray-100 hover:border-teal-200 hover:border border-gray-200 transition-all duration-300 transform hover:-translate-y-1"
            >
              <div className="grid lg:grid-cols-2 gap-0">
                {featuredArticle.coverImageUrl && (
                  <div className="aspect-[4/3] lg:aspect-auto bg-teal-50 overflow-hidden">
                    <img
                ...
                <div className="p-10 flex flex-col justify-center">
                  {featuredArticle.program && (
                    <div className="inline-flex items-center space-x-2 bg-teal-50 text-teal-600 px-4 py-2 rounded-full text-sm font-bold mb-4 w-fit border border-teal-200">
                  ...
                  <h3 className="text-3xl font-bold text-gray-900 mb-4 group-hover:text-teal-600 transition-colors leading-tight">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="inline-flex items-center text-teal-600 font-bold group-hover:translate-x-2 transition-transform">
                      Baca Selengkapnya
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {remainingArticles.map((article) => (
                <Link
                  ...
                  className="group bg-white rounded-lg overflow-hidden border-2 border-gray-100 hover:border-teal-200 shadow-md hover:border border-gray-200 transition-all duration-300 transform hover:-translate-y-1"
                >
                  ...
                  <div className="p-6">
                    {article.program && (
                      <div className="inline-block bg-teal-50 text-teal-600 px-3 py-1.5 rounded-lg text-xs font-bold mb-3 border border-teal-100">
