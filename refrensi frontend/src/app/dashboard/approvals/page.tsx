            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="bg-white rounded-lg p-5 border border-gray-200">
                    <div className="flex items-center justify-between mb-3">
                        ...
                        <div className="text-2xl font-semibold text-teal-600">{stats.pending}</div>
                    </div>
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
                ...
                <div className="relative">
                    ...
                    <select
                        ...
                        className="w-full md:w-auto pl-9 pr-8 py-2.5 text-sm rounded-md border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none appearance-none bg-white"
                    >
            ...
            {isLoading ? (
                ...
                <div className="space-y-4">
                    {approvalsList.map((approval: any) => (
                        <div
                            key={approval.id}
                            className="bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-colors overflow-hidden"
                        >
                            <div className="p-6">
                                    ...
                                    {approval.status === 'PENDING' && (
                                        <div className="flex gap-3">
                                            <Link
                                                ...
                                                className="px-6 py-2.5 bg-teal-500 text-white rounded-md text-sm font-medium hover:bg-teal-600 transition-colors"
                                            >
                                                Tinjau
                                            </Link>
                                        </div>
