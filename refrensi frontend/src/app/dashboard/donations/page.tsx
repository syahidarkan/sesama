  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 animate-fadeIn animate-stagger-1">
        ...
        <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-lg border border-teal-200 p-5">
          <div className="flex items-center justify-between mb-2">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-lg border border-blue-200 p-5">
          ...
          <div className="text-sm text-cyan-800 mb-1">Total Transaksi</div>
      ...
      {/* Info Box */}
      {donations && donations.length > 0 && (
        <div className="bg-cyan-50 rounded-lg border border-blue-200 p-5">
          <div className="flex items-start space-x-3">
            <div className="w-10 h-10 bg-cyan-100 rounded-lg flex items-center justify-center shrink-0">
              <Download className="w-5 h-5 text-cyan-600" />
            </div>
            <div>
              <h3 className="text-sm font-semibold text-cyan-900 mb-1">
                Butuh Bukti Donasi?
              </h3>
