        ...
        <div className="space-y-6">
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-6">
                <div className="flex items-start justify-between">
                    <div>
                        <span className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-md text-xs font-medium bg-teal-50 border border-teal-200 text-teal-700 mb-3">
            ...
            {user?.role === 'USER' && (
                <div className="bg-gradient-to-br from-teal-50 to-cyan-100 rounded-lg border border-teal-200 overflow-hidden">
                    <div className="p-6">
                        {!upgradeRequest ? (
                                    ...
                                    <div>
                                        ...
                                        <ul className="space-y-2 mb-4">
                                            <li className="flex items-start text-sm text-gray-700">
                                                <CheckCircle className="w-4 h-4 text-teal-600 mr-2 mt-0.5 shrink-0" />
                                        ...
                                        <Link
                                            ...
                                            className="inline-flex items-center space-x-2 px-5 py-2.5 bg-teal-500 text-white text-sm font-medium rounded-lg hover:bg-teal-600 transition-colors"
                                        >
                ...
                <div className="px-6 py-4 border-b border-gray-200">
                    <div className="flex items-center justify-between">
                        ...
                        <Link
                            ...
                            className="inline-flex items-center space-x-2 px-4 py-2 bg-teal-500 text-white text-sm font-medium rounded-md hover:bg-teal-600 transition-colors"
                        >
                    ...
                    {loadingPrograms ? (
                        ...
                        <div className="space-y-3">
                            {programsList.slice(0, 5).map((program: any) => (
                                ...
                                >
                                    <div className="p-4 rounded-md border border-gray-200 hover:border-teal-300 hover:bg-teal-50/30 transition-colors">
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1 min-w-0">
                                                <div className="flex items-center space-x-2 mb-2">
                                                    <h3 className="text-sm font-medium text-gray-900 group-hover:text-teal-600 transition-colors truncate">
                                                        {program.title}
                                                    </h3>
                                                    <span
                                            ...
                                            <ArrowRight className="w-4 h-4 text-gray-400 group-hover:text-teal-600 shrink-0 ml-4" />
                                        </div>
                                    </div>
                                </Link>
                            ))}
                        ...
                        <div className="text-center py-12">
                            ...
                            <Link
                                ...
                                className="inline-flex items-center px-4 py-2 bg-teal-500 text-white text-sm font-medium rounded-md hover:bg-teal-600 transition-colors"
                            >
                                Buat Program Baru
                            </Link>
                        </div>
            ...
            {user?.role !== 'USER' && pendingApprovals.length > 0 && (
                <div className="bg-white rounded-lg border border-teal-200 overflow-hidden">
                    <div className="px-6 py-4 border-b border-teal-200 bg-teal-50">
                        <div className="flex items-center justify-between">
                            <div>
                                        ...
                                        <div className="flex items-start justify-between">
                                            <div className="flex-1">
                                                <div className="flex items-center space-x-3 mb-2">
                                                    ...
                                                    <span className="inline-flex px-2 py-0.5 rounded text-xs font-medium bg-teal-50 text-teal-700 border border-teal-200">
                                                        PENDING
                                                    </span>
                                                </div>
