    ...
    return (
        <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <Link
                    href="/dashboard/programs"
                    className="inline-flex items-center space-x-2 text-gray-600 hover:text-teal-600 text-sm font-medium transition-colors"
                >
                    <div className="w-8 h-8 rounded-md bg-gray-100 hover:bg-teal-50 flex items-center justify-center transition-colors">
                        <ArrowLeft className="w-4 h-4" />
                    </div>
                    <span>Kembali ke Daftar Program</span>
                </Link>
                        ...
                        <div className="p-6">
                            ...
                            <div className="bg-teal-50 rounded-lg p-6 border border-teal-200">
                                <div className="flex justify-between items-center mb-3">
                                    ...
                                    <span className="text-xl font-semibold text-teal-600">{progress}%</span>
                                </div>
                                <div className="w-full h-2 bg-white rounded-full overflow-hidden mb-4 border border-teal-200">
                                    <div
                                ...
                                <div className="flex justify-between items-center">
                                    <div>
                                        <div className="text-xs text-teal-700 mb-1">Terkumpul</div>
                                        <div className="text-lg font-semibold text-orange-900">
                                            Rp {parseInt(program.collectedAmount || '0').toLocaleString('id-ID')}
                                        </div>
                                    </div>
                                    <div className="text-right">
                                        <div className="text-xs text-teal-700 mb-1">Target</div>
                                        <div className="text-lg font-semibold text-orange-900">
                ...
                <div className="space-y-6">
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="bg-white rounded-lg p-5 border border-gray-200">
                            ...
                            <div className="text-3xl font-semibold text-cyan-600 mb-1">{progress}%</div>
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 p-6">
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="w-12 h-12 rounded-lg bg-teal-500 flex items-center justify-center text-white font-medium text-lg">
                            ...
                            <div className="space-y-3">
                                {program.category && (
                                    <div>
                                        ...
                                        <div className="px-3 py-1.5 bg-teal-50 text-teal-700 border border-teal-200 rounded-md font-medium text-sm inline-block">
                                            {program.category}
                                        </div>
                                    </div>
                                )}
                                {program.programType && (
                                    <div>
                                        ...
                                        <div className="px-3 py-1.5 bg-cyan-50 text-cyan-700 border border-blue-200 rounded-md font-medium text-sm inline-block">
                                            {program.programType}
                                        </div>
                                    </div>
                                )}
