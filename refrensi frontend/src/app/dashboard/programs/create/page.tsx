        ...
        return (
            <div className="space-y-6">
                <div className="flex items-center gap-4">
                    <Link href="/dashboard/programs" className="w-10 h-10 flex items-center justify-center rounded-lg bg-gray-100 hover:bg-teal-50 transition-colors">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <button
                        ...
                        className="group bg-white rounded-lg p-8 border border-gray-200 hover:border-teal-500 transition-all text-left"
                    >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className="w-full px-4 py-2.5 text-sm border border-gray-300 rounded-md focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none appearance-none bg-white"
                            >
                    ...
                    <div className="bg-teal-50 rounded-lg p-6 border border-teal-200">
                        ...
                        <dl className="space-y-3">
                            <div className="flex justify-between items-center py-2 border-b border-teal-200">
                                <dt className="text-sm text-teal-700">Judul:</dt>
                                <dd className="text-sm font-medium text-orange-900 text-right">{formData.title || '-'}</dd>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-teal-200">
                                <dt className="text-sm text-teal-700">Target:</dt>
                                <dd className="text-sm font-medium text-orange-900">Rp {parseInt(formData.targetAmount || '0').toLocaleString('id-ID')}</dd>
                            </div>
                            <div className="flex justify-between items-center py-2 border-b border-teal-200">
                                <dt className="text-sm text-teal-700">Lembaga:</dt>
                                <dd className="text-sm font-medium text-orange-900 text-right">{formData.institutionName || '-'}</dd>
                            </div>
                            <div className="flex justify-between items-center py-2">
                                <dt className="text-sm text-teal-700">PIC:</dt>
                                <dd className="text-sm font-medium text-orange-900 text-right">{formData.picName || '-'}</dd>
                            </div>
                        </dl>
                    </div>
                    <p className="text-sm text-gray-600 bg-cyan-50 p-4 rounded-lg border border-blue-200">
                        <span className="font-medium text-cyan-900">Perhatian:</span> Pastikan semua data sudah benar sebelum mengirim. Program akan diproses setelah disubmit.
                    </p>
                </div>
            );
        }
            ...
            <div className="bg-white rounded-lg border border-gray-200 p-8">
                <div className="flex items-center space-x-3 mb-6">
                    <div className="w-10 h-10 bg-teal-100 rounded-lg flex items-center justify-center">
                        <CurrentStepIcon className="w-5 h-5 text-teal-600" />
                    </div>
            ...
            <div className="flex justify-between items-center bg-white rounded-lg border border-gray-200 p-6">
                ...
                {isLastStep ? (
                    ...
                    <button
                        ...
                        className="inline-flex items-center space-x-2 px-8 py-2.5 bg-teal-500 text-white rounded-md text-sm font-medium hover:bg-teal-600 transition-colors"
                    >
                        <span>Lanjutkan</span>
