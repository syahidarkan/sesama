                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    ...
                    {canCreate && (
                        <Link
                            ...
                            className="inline-flex items-center justify-center space-x-2 px-4 py-2 rounded-md bg-teal-500 text-white text-sm font-medium hover:bg-teal-600 transition-colors"
                        >
                ...
                <div className="mt-6 grid md:grid-cols-2 gap-3">
                    <div className="relative">
                        ...
                        <input
                            ...
                            className="w-full pl-9 pr-3 py-2 text-sm rounded-md border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none"
                        />
                    </div>
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="w-full pl-9 pr-3 py-2 text-sm rounded-md border border-gray-300 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none appearance-none bg-white"
                        >
                    ...
                    {filteredPrograms.map((program: any) => {
                        ...
                        return (
                            <Link
                                ...
                                className="group bg-white rounded-lg border border-gray-200 hover:border-teal-500 transition-colors overflow-hidden"
                            >
                                {program.imageUrl && (
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-12">
                    <div className="text-center">
                        ...
                        {canCreate && !searchQuery && (
                            <Link
                                href="/dashboard/programs/create"
                                className="inline-flex items-center space-x-2 px-4 py-2 rounded-md bg-teal-500 text-white text-sm font-medium hover:bg-teal-600 transition-colors"
                            >
                                <Plus className="w-4 h-4" />
                                <span>New Program</span>
                            </Link>
