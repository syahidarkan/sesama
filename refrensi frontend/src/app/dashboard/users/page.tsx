...
export default function UsersPage() {
    ...
    const getRoleBadge = (role: string) => {
        const colors = {
            ...
            ADMIN_IT: 'bg-cyan-50 text-cyan-700 border-blue-200',
        ...
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
                ...
                <div className="bg-white rounded-lg p-5 border border-gray-200">
                    ...
                    <div className="text-3xl font-semibold text-teal-600 mb-1">{stats.admins}</div>
                ...
                <div className="grid md:grid-cols-3 gap-4">
                    ...
                    <div className="relative">
                        ...
                        <select
                            ...
                            className="w-full pl-9 pr-4 py-2.5 text-sm border border-gray-300 rounded-md focus:border-teal-500 focus:ring-1 focus:ring-teal-500 transition-colors outline-none appearance-none bg-white"
                        >
                                    ...
                                    <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                                        <td className="px-6 py-4">
                                            <div className="flex items-center space-x-3">
                                                <div className="w-10 h-10 rounded-lg bg-teal-500 flex items-center justify-center text-white font-medium">
