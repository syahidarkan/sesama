      ...
      <div className="max-w-2xl w-full">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 rounded-lg border border-gray-200 border-2 border-blue-200 p-6 mb-6">
          <div className="flex items-start space-x-4">
            ...
            <div className="flex-1">
              <h3 className="font-bold text-cyan-900 mb-2">Apa yang Harus Dilakukan?</h3>
            ...
            <div className="flex-1">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="inline-flex items-center space-x-2 px-4 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-sm font-semibold rounded-lg transition-colors"
                >
        ...
        <Link
          href="/"
          className="block w-full text-center px-8 py-4 bg-teal-500 text-white font-bold rounded-xl border border-gray-200 shadow-teal-500/30 hover:border border-gray-200 hover:shadow-teal-500/40 transform hover:-translate-y-0.5 transition-all"
        >
          Kembali ke Beranda
        </Link>
      </div>
