...
export default function LoginPage() {
        ...
        <div className="w-full max-w-md">
          <div className="text-center mb-10">
            <Link href="/" className="inline-flex items-center space-x-2 mb-10">
              ...
              <span className="text-2xl font-bold text-gray-900">LAZISMU</span>
            </Link>
            ...
            <form onSubmit={handleVerifyOTP} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  placeholder="000000"
                  maxLength={6}
                  className="w-full px-6 py-4 rounded-xl border-2 border-gray-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 text-center text-3xl tracking-[0.5em] font-bold text-gray-900 transition-all outline-none"
                  required
                  autoFocus
                />
              ...
              <button
                ...
                className="w-full py-4 rounded-xl bg-gradient-to-r from-teal-500 to-cyan-600 text-white font-bold text-lg shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed transform hover:-translate-y-0.5"
              >
                {isLoading ? (
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <div className="flex items-center justify-between">
                <button
                  ...
                  disabled={isLoading}
                  className="text-sm text-teal-600 hover:text-teal-700 font-semibold disabled:opacity-50 transition-colors"
                >
                  Kirim Ulang Kode
                </button>
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 flex">
        ...
        <div className="w-full max-w-md">
          <div className="mb-10">
            <Link href="/" className="inline-flex items-center space-x-2 group">
              <div className="w-11 h-11 bg-teal-500 rounded-xl flex items-center justify-center group-hover:shadow-lg transition-shadow">
                <span className="text-white font-bold text-xl">L</span>
              </div>
              <span className="text-2xl font-bold text-gray-900">LAZISMU</span>
            </Link>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-4 py-3.5 rounded-xl border-2 border-gray-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all outline-none text-gray-900"
                    required
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-12 pr-12 py-3.5 rounded-xl border-2 border-gray-200 focus:border-teal-500 focus:ring-4 focus:ring-teal-500/10 transition-all outline-none text-gray-900"
                    required
                  />
                  <button
                    type="button"
      ...
      {/* Right Side - Visual */}
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-teal-500 to-cyan-600 p-12 items-center justify-center relative overflow-hidden">
