...
export default function HomePage() {
  ...
  const totalDonors = programs.length; // Using program count as proxy since donorCount not in type
  ...
  return (
    <div className="min-h-screen bg-gray-50">
              ...
              {!mounted ? (
                ...
                <Link
                  href={user?.role && ['MANAGER', 'CONTENT_MANAGER', 'SUPERVISOR', 'SUPER_ADMIN', 'PENGUSUL'].includes(user.role)
                    ? '/admin/dashboard'
                    : '/dashboard'}
                  className="px-6 py-3 bg-gradient-to-r from-teal-500 to-cyan-600 text-white rounded-xl font-semibold shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 transform hover:-translate-y-0.5"
                >
                  Dashboard
                </Link>
              ) : (
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-teal-50 via-white to-cyan-50/30">
        <div className="absolute inset-0 bg-grid-slate-100 [mask-image:linear-gradient(0deg,white,rgba(255,255,255,0.6))] -z-10" />

        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-24 lg:py-32">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div className="space-y-8">
              <div className="inline-flex items-center space-x-2 px-4 py-2 bg-teal-100 text-teal-700 rounded-full text-sm font-semibold">
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link
                  href="/programs"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-teal-500 to-cyan-600 text-white rounded-xl font-semibold text-lg shadow-lg shadow-teal-500/30 hover:shadow-teal-500/50 transition-all duration-300 transform hover:-translate-y-1"
                >
                  Mulai Berdonasi
                ...
                <Link
                  href="/about"
                  className="inline-flex items-center justify-center px-8 py-4 bg-white hover:bg-gray-50 text-gray-900 rounded-xl font-semibold text-lg border-2 border-gray-200 hover:border-teal-300 transition-all duration-300"
                >
                  Cara Kerja Kami
                </Link>
              </div>
              ...
              <div className="grid grid-cols-3 gap-8 pt-8 border-t border-gray-200">
                ...
                <div>
                  <div className="text-2xl font-bold text-gray-900">
                    {mounted ? `${totalDonors.toLocaleString('id-ID')}+` : '0+'}
                  </div>
            ...
            <div className="relative">
              <div className="relative bg-teal-50 rounded-lg p-8 border border-gray-200 border border-teal-100">
                ...
                <div className="relative bg-white rounded-lg p-6 border border-gray-200 space-y-4">
                  ...
                  <div className="text-4xl font-bold bg-teal-500 bg-clip-text text-transparent">
                    {mounted ? formatCurrency(totalCollected) : 'Rp 0'}
                  </div>
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {programs.slice(0, 6).map((program) => {
                ...
                const daysLeft = program.closedAt ? calculateDaysLeft(program.closedAt) : 30; // Default 30 days if no closedAt

                return (
                  <Link
                    key={program.id}
                    href={`/programs/${program.slug}`}
                    className="group bg-white rounded-lg overflow-hidden border border-gray-200 border border-gray-100 hover:border border-gray-200 hover:border-teal-200 transition-all duration-300 transform hover:-translate-y-2"
                  >
                    ...
                    <div className="p-6 space-y-4">
                      <h3 className="text-xl font-bold text-gray-900 line-clamp-2 leading-snug group-hover:text-teal-600 transition-colors">
                        {program.title}
                      </h3>
                      ...
                      <div className="space-y-3">
                        <div>
                          ...
                          <div className="relative w-full h-3 bg-gray-100 rounded-full overflow-hidden">
                            <div
                              className="absolute inset-y-0 left-0 bg-teal-500 rounded-full transition-all duration-1000 ease-out"
                        ...
                        <div className="flex items-center justify-between">
                          <div>
                            <div className="text-xl font-bold text-gray-900">
                              {mounted ? formatCurrency(program.collectedAmount) : 'Rp 0'}
                            </div>
                      ...
                      <div className="pt-4 border-t border-gray-100">
                        <div className="flex items-center justify-between text-sm">
                          <span className="text-gray-600">
                            {program.creator?.name || 'Lembaga'}
                          </span>
                          <span className="text-teal-600 font-semibold group-hover:translate-x-1 transition-transform">
                            Donasi →
                          </span>
                        </div>
                      </div>
      ...
      <section className="py-20 px-6 lg:px-8 bg-white">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group p-8 bg-teal-50 rounded-lg hover:shadow-xl transition-all duration-300 border border-teal-100">
              <div className="w-14 h-14 bg-teal-500 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="group p-8 bg-cyan-50 rounded-lg hover:shadow-xl transition-all duration-300 border border-cyan-100">
              <div className="w-14 h-14 bg-cyan-600 rounded-lg flex items-center justify-center mb-6 group-hover:scale-110 transition-transform duration-300">
                <svg className="w-7 h-7 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                >
                  ...
                  <div className="text-right">
                    <div className="text-2xl font-bold bg-teal-500 bg-clip-text text-transparent">
                      {mounted ? formatCurrency(Number(entry.totalDonations)) : 'Rp 0'}
                    </div>
