    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          <Link href="/pelaporan" className="text-teal-600 hover:text-teal-700 font-medium">
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <article className="max-w-4xl mx-auto px-4 py-12">
        ...
        {pelaporan.program && (
          <div className="mt-12 bg-teal-50 rounded-xl border border-teal-200 p-8">
            <h3 className="text-xl font-bold text-gray-900 mb-4">Program Terkait</h3>
            <Link
              href={`/programs/${pelaporan.program.slug}`}
              className="text-teal-600 hover:text-teal-700 font-semibold text-lg inline-flex items-center gap-2"
            >
              {pelaporan.program.title}
